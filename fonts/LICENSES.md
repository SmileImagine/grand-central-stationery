...
Every font in this folder is under the SIL Open Font License 1.1. The files are the woff2 subsets served by Google Fonts. `gcs-accidentals.woff2` (in the project root, and embedded in the pages) is a derivative of Noto Music: two glyphs, ♯ and ♭, with their advance set to zero; per the OFL it is not called Noto. The wordmark in the page is SVG outlines set from Cinzel and Caveat; the fonts themselves are not bundled.
...
## Noto Music (and GCS Accidentals)
